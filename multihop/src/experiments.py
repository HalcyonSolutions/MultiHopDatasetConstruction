...
def construct_model(args):
    ...
    print(f'Constructing a model --> {args.model}')
...
def train(lf):
    ...
    print(f'First instance of the train data --> {train_data[0]}')
    # sys.exit()
