...
python fbwiki_triplet_creation.py --entity-list-path './data/nodes_fb_wiki_v3.txt' --triplet-output-path ./data/triplet_creation_fb_wiki_v4.txt --forwarding-output-path ./data/forwarding_creation_fb_wiki_v4.txt
echo